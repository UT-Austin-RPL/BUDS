...
import init_path
from multitask.hierarchical_agglomoration_utils import Node, HierarchicalAgglomorativeTree, save_agglomorative_tree
...
def main(hydra_cfg: DictConfig):
    ...
    with open(f"results/trees/{cfg.data.dataset_name}_trees_{modality_str}_{cfg.agglomoration.footprint}_{cfg.agglomoration.dist}.pkl", "wb") as f:
        pickle.dump(trees, f)
