...
def main(hydra_cfg):
    ...
    if not cfg.meta.use_rnn:
        ...
        dataset = MultitaskMetaPolicyDataset(data_file_name=folder_path + f"datasets/{cfg.data.dataset_name}/demo.hdf5",
                                    ...
                                    subtasks_file_name=f"results/skill_data/{cfg.data.dataset_name}_subtasks_{modality_str}_{cfg.repr.z_dim}_{cfg.agglomoration.footprint}_{cfg.agglomoration.dist}_{cfg.agglomoration.segment_footprint}_K{cfg.skill_training.agglomoration.K}_{cfg.agglomoration.affinity}.hdf5",
    ...
    template = multitask_meta_path_template(cfg)
