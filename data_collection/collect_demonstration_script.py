...
if __name__ == "__main__":
    ...
    parser.add_argument("--task", type=str, default=None, help="for multitask name")
    ...
    new_dir = os.path.join(args.directory, "{}_pick_{}_place_{}_{}_{}".format(args.environment, args.pick_id, args.place_id, t1, t2))
    os.makedirs(new_dir)
